...
module Maps =
    ...
    type VEMap = 
        ...
        member this.AddControl(element: Dom.Element, zIndex: int) : unit = Undefined

        member this.AddControl(element: Dom.Element) : unit = Undefined
        ...
        member this.DeleteControl(element: Dom.Element) : unit = Undefined
        ...
        member this.HideControl(element: Dom.Element) : unit = Undefined
        ...
        member this.ShowControl(element: Dom.Element) : unit = Undefined
